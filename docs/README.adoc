...
5irechain has three distinct features that make it "next-generation": 
- a dynamic, self-defining state-transition function
- light-client functionality from day one
- and a progressive consensus algorithm with fast block production and adaptive, definite finality.
