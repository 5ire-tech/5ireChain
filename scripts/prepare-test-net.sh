...
SECRET="prefer butter fluid ivory eyebrow pony gym snap divert wide run foam"
...
# for i in $(seq 1 $V_NUM); do
	...
	AUTHORITIES+="),\n"
	# $AUTHORITIES+="(\n $(generate_address_and_account_id $i stash)\n $(generate_address_and_account_id $i controller)\n $(generate_address_and_account_id $i grandpa '--scheme ed25519' true)\n $(generate_address_and_account_id $i babe '--scheme sr25519' true)\n $(generate_address_and_account_id $i im_online '--scheme sr25519' true)\n $(generate_address_and_account_id $i authority_discovery '--scheme sr25519' true)\n ),\n"
# done
