...
fn it_must_upload_all_valid_esg_data_with_no_skipping() {
	new_test_ext().execute_with(|| {
		...
		let company1 = AccountId20::from_str("82a0EcfDd3174bEF5D5eA452e15219A52bf6161f").unwrap();
		let company2 = AccountId20::from_str("Ba08C49f377a4F01c65340F431B5C65D71B972a9").unwrap();
...
fn it_must_skip_for_invalid_addresses_in_esg_data() {
	new_test_ext().execute_with(|| {
		...
		let valid_id1 = AccountId20::from_str("82a0EcfDd3174bEF5D5eA452e15219A52bf6161f").unwrap();
		let valid_id2 = AccountId20::from_str("25Db9D98e4Ab6af68ac7173f580c444155B7b5C8").unwrap();
...
fn it_must_handle_invalid_esg_scores() {
	new_test_ext().execute_with(|| {
		...
		let company1 = AccountId20::from_str("82a0EcfDd3174bEF5D5eA452e15219A52bf6161f").unwrap();
		let company2 = AccountId20::from_str("Ba08C49f377a4F01c65340F431B5C65D71B972a9").unwrap();
		let company3 = AccountId20::from_str("25Db9D98e4Ab6af68ac7173f580c444155B7b5C8").unwrap();
